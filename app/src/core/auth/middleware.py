...
async def require_api_key(request: Request) -> str:
    """
    Dependency function to extract API key from authenticated request.

    This function assumes the AuthenticationMiddleware has already run
    and validated the request. It simply extracts the API key from
    ...
    Raises:
        AuthenticationRequiredError: If request is not properly authenticated
    """
